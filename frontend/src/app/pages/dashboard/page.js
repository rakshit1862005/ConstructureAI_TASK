...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-gray-950 flex flex-col">
            ...
            {/* Chat container */}
            <div className="flex-1 flex flex-col max-w-5xl w-full mx-auto min-h-0 bg-gray-900 rounded-t-xl mt-4 mx-4 border border-gray-800">
                {/* Messages */}
                <div className="flex-1 overflow-y-auto px-6 py-8 min-h-0 bg-gray-900">
